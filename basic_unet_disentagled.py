...
class BasicUNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # if isMRI:
        x1 = self._maybe_checkpoint(lambda x: self.act_0_0(self.norm_0_0(self.conv_0_0(x))), x)#, use_reentrant=False)
        x1 = self._maybe_checkpoint(lambda x: self.act_0_1(self.norm_0_1(self.conv_0_1(x))), x1)#, use_reentrant=False)
        
        x2 = self.pool_1(x1)
        x2 = self._maybe_checkpoint(lambda x: self.act_1_0(self.norm_1_0(self.conv_1_0(x))), x2)#, use_reentrant=False)
        x2 = self._maybe_checkpoint(lambda x: self.act_1_1(self.norm_1_1(self.conv_1_1(x))), x2)#, use_reentrant=False)
        
        x3 = self.pool_2(x2)
        x3 = self._maybe_checkpoint(lambda x: self.act_2_0(self.norm_2_0(self.conv_2_0(x))), x3)#, use_reentrant=False)
        x3 = self._maybe_checkpoint(lambda x: self.act_2_1(self.norm_2_1(self.conv_2_1(x))), x3)#, use_reentrant=False)

        x4 = self.pool_3(x3)
        x4 = self._maybe_checkpoint(lambda x: self.act_3_0(self.norm_3_0(self.conv_3_0(x))), x4)#, use_reentrant=False)
        x4 = self._maybe_checkpoint(lambda x: self.act_3_1(self.norm_3_1(self.conv_3_1(x))), x4)#, use_reentrant=False)

        # Decoder with gradient checkpointing
        x4 = self.up_4(x4)
        x4 = torch.cat([x4, x3], dim=1)
        x4 = self._maybe_checkpoint(lambda x: self.act_up_4_0(self.norm_up_4_0(self.conv_up_4_0(x))), x4)#, use_reentrant=False)
        x4 = self._maybe_checkpoint(lambda x: self.act_up_4_1(self.norm_up_4_1(self.conv_up_4_1(x))), x4)#, use_reentrant=False)

        x3 = self.up_3(x4)
        x3 = torch.cat([x3, x2], dim=1)
        x3 = self._maybe_checkpoint(lambda x: self.act_up_3_0(self.norm_up_3_0(self.conv_up_3_0(x))), x3)#, use_reentrant=False)
        x3 = self._maybe_checkpoint(lambda x: self.act_up_3_1(self.norm_up_3_1(self.conv_up_3_1(x))), x3)#, use_reentrant=False)

        x2 = self.up_2(x3)
        x2 = torch.cat([x2, x1], dim=1)
        x2 = self._maybe_checkpoint(lambda x: self.act_up_2_0(self.norm_up_2_0(self.conv_up_2_0(x))), x2)#, use_reentrant=False)
        x2 = self._maybe_checkpoint(lambda x: self.act_up_2_1(self.norm_up_2_1(self.conv_up_2_1(x))), x2)#, use_reentrant=False)
